...
class Demo extends StatefulWidget {
  ...
  final MediaDetailsResponse response;
...
class _MyHomePageState extends State<Demo> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text(widget.response.title),
      ),
      body: Builder(
  ...
  Future<Null> _prepare() async {
    ...
    _tasks.addAll(widget.response.seriesList.map((item) => _TaskInfo(name: item.zhuti, link: item.downloadUrl)));
